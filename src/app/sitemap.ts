...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    { url: "https://www.alunisson.eu", lastModified: new Date() },
    { url: "https://www.alunisson.eu/ateliers", lastModified: new Date() },
    { url: "https://www.alunisson.eu/philosophie", lastModified: new Date() },
    { url: "https://www.alunisson.eu/creations", lastModified: new Date() },
